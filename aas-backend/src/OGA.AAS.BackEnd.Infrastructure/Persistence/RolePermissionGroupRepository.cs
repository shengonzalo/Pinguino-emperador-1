...
{
    public class RolePermissionGroupRepository : BaseAsyncRepository<RolePermissionGroup>, IRolePermissionGroupRepository
    {
        public IBaseAsyncRepository<RolePermissionGroup> BaseRepository;

        public RolePermissionGroupRepository(BaseDbContext context, ILoggingService logger) : base(context, logger)
        {
            BaseRepository = this;
        }
    }
