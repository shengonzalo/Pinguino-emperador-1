            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `oga.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `oga.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--oga-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--oga-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
