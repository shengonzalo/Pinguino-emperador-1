...
import { OgaHighlightService } from '@oga/components/highlight/highlight.service';

@Component({
    selector: 'textarea[oga-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'ogaHighlight',
    standalone: true,
    imports: [NgClass],
})
export class OgaHighlightComponent implements OnChanges, AfterViewInit {
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _ogaHighlightService: OgaHighlightService,
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._ogaHighlightService.highlight(this.code, this.lang)
        );
