...
export class OgaMasonryComponent implements OnChanges, AfterViewInit {
     ...
     * Constructor
     */
    constructor(private _ogaMediaWatcherService: OgaMediaWatcherService) {}
