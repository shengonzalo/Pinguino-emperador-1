...
export class OgaNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, OgaNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: OgaNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): OgaNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: OgaNavigationItem[],
        flatNavigation: OgaNavigationItem[] = []
    ): OgaNavigationItem[] {
    ...
    getItemParent(
        id: string,
        navigation: OgaNavigationItem[],
        parent: OgaNavigationItem[] | OgaNavigationItem
    ): OgaNavigationItem[] | OgaNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
