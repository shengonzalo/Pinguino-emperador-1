...
@Component({
    selector: 'oga-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => OgaVerticalNavigationCollapsableItemComponent),
...
export class OgaVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'oga-vertical-navigation-item-collapsed': this.isCollapsed,
            'oga-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._ogaVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._ogaVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._ogaVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._ogaVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
