...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _ogaConfigService: OgaConfigService,
        private _ogaMediaWatcherService: OgaMediaWatcherService,
        private _ogaPlatformService: OgaPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            ...
            this._ogaMediaWatcherService.onMediaQueryChange$([
        ...
        this._renderer2.addClass(
            this._document.body,
            this._ogaPlatformService.osName
        );
    }
